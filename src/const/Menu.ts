...
export const MENU_PERFIL = [
  ...
  },
  {
    ...
    estado: "Pròximament",
    icono:
      '<path d="M509-269q-29-29-29-71t29-71 71-29 71 29 29 71-29 71-71 29-71-29M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80zm0-80h560v-400H200zm0-480h560v-80H200zm0 0v-80z"/>',
  },
  {
    ...
    estado: "Pròximament",
    icono:
      '<path d="M480-120q-138 0-240.5-91.5T122-440h82q14 104 92.5 172T480-200q117 0 198.5-81.5T760-480t-81.5-198.5T480-760q-69 0-129 32t-101 88h110v80H120v-240h80v94q51-64 124.5-99T480-840q75 0 140.5 28.5t114 77 77 114T840-480t-28.5 140.5-77 114-114 77T480-120m112-192L440-464v-216h80v184l128 128z"/>',
  },
];
...
export const MENU_ADMIN = [
  ...
  },
  {
    ...
    estado: "Activa",
    icono:
      '<path d="M160-120q-33 0-56.5-23.5T80-200v-640l67 67 66-67 67 67 67-67 66 67 67-67 67 67 66-67 67 67 67-67 66 67 67-67v640q0 33-23.5 56.5T800-120zm0-80h280v-240H160zm360 0h280v-80H520zm0-160h280v-80H520zM160-520h640v-120H160z"/>',
  },
  {
    nombre: "Tornejos",
  ...
  },
  {
    ...
    estado: "Activa",
    icono:
      '<path d="M287-527q-47-47-47-113t47-113 113-47 113 47 47 113-47 113-113 47-113-47M80-160v-112q0-33 17-62t47-44q51-26 115-44t141-18h14q6 0 12 2-8 18-13.5 37.5T404-360h-4q-71 0-127.5 18T180-306q-9 5-14.5 14t-5.5 20v32h252q6 21 16 41.5t22 38.5zm560 40-12-60q-12-5-22.5-10.5T584-204l-58 18-40-68 46-40q-2-14-2-26t2-26l-46-40 40-68 58 18q11-8 21.5-13.5T628-460l12-60h80l12 60q12 5 22.5 11t21.5 15l58-20 40 70-46 40q2 12 2 25t-2 25l46 40-40 68-58-18q-11 8-21.5 13.5T732-180l-12 60zm96.5-143.5Q760-287 760-320t-23.5-56.5T680-400t-56.5 23.5T600-320t23.5 56.5T680-240t56.5-23.5m-280-320Q480-607 480-640t-23.5-56.5T400-720t-56.5 23.5T320-640t23.5 56.5T400-560t56.5-23.5M412-240"/>',
  },
  {
