...
export default function JornadaActual({ jornada }: Props) {
  return (
      ...
      {!jornada ? (
        ...
        <div className="divide-y divide-border/50">
          {jornada.partidos.map((partit) => {
            const teResultat =
              partit.resultadoLocal !== null &&
              partit.resultadoVisitante !== null;

            return (
              <article key={partit.id} className="px-5 py-4">
                  ...
                  <div className="min-w-16 text-center">
                    {teResultat ? (
                      <p className="text-lg font-bold text-neutral-titulos">
                        {partit.resultadoLocal} - {partit.resultadoVisitante}
                      </p>
                    ) : (
