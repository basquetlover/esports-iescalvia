export default function Enviando() {
    return (
        <div className="w-full h-full fixed z-20 top-0 left-0 flex flex-col items-center place-content-center bg-background/60 backdrop-blur-sm">
            ...
            <p className="text-gray-300 font-light mb-xl px-md">
                Si us plau, espera mentre es processa la sol·licitud. No tanquis aquesta finestra.
            </p>
            {/* <!-- Custom Progress Bar --> */}
